...
One last thing: when you want to open a page on the internet, you end the file name with ```.md```. Then open the website from the Pages tab in the repo's Settings, and copy the file name. Just remember to end the file name with ```.html``` to open it.
